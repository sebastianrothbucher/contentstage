...
let pageres = new Promise((resolve, rejectt) => connection.query(
        "select p.identifier as p_identifier, p.title as p_title, p.page_layout as p_page_layout, " + 
        "p.content_heading as p_content_heading, p.content as p_content, p.update_time as p_update_time, " + 
        "p.is_active as p_is_active, s.code as s_code " + 
